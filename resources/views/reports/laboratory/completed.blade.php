@extends('layouts.app')
@section('title', 'Completed Tests Report')
@section('page-title', 'Completed Tests Report')
@section('content')

@include('reports._print-header', ['reportTitle' => 'Completed Tests Report'])
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
        <h6 class="fw-bold mb-0"><i class="bi bi-check-circle me-2"></i>Completed Lab Requests</h6>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="6" class="text-center py-4 text-muted"><i class="bi bi-inbox me-2"></i>No completed tests found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
