    ...
    <div class="col-md-6 col-xl-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-header bg-success bg-opacity-10 border-0 py-3 d-flex align-items-center justify-content-between">
                <h6 class="fw-bold text-success mb-0"><i class="bi bi-activity me-2"></i>Radiology (RIS)</h6>
                <span class="badge bg-success">{{ $summary['radiology']['total'] }} Total</span>
            </div>
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2"><span>Pending:</span><strong class="text-secondary">{{ $summary['radiology']['pending'] }}</strong></div>
                <div class="d-flex justify-content-between mb-2"><span>In Progress:</span><strong class="text-success">{{ $summary['radiology']['in_progress'] }}</strong></div>
                <hr>
                <div class="d-flex justify-content-between fw-bold"><span>Completion Rate:</span><span class="text-success">{{ $summary['radiology']['completion_rate'] }}%</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card h-100 border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2"><span>Verified:</span><strong class="text-success">{{ $summary['pharmacy']['verified'] }}</strong></div>
                <div class="d-flex justify-content-between mb-2"><span>Pending:</span><strong class="text-secondary">{{ $summary['pharmacy']['pending'] }}</strong></div>
                <hr>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card h-100 border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2"><span>Scheduled:</span><strong class="text-success">{{ $summary['surgery']['scheduled'] }}</strong></div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-header bg-secondary bg-opacity-10 border-0 py-3 d-flex align-items-center justify-content-between">
                ...
                <span class="badge bg-secondary">{{ $summary['diet']['total_requests'] }} Total</span>
            </div>
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2"><span>Total Plans:</span><strong class="text-dark">{{ $summary['diet']['total_plans'] }}</strong></div>
