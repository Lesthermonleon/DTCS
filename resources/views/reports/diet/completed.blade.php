@extends('layouts.app')
@section('title', 'Completed Diet Plans Report')
@section('page-title', 'Completed Diet Plans Report')
@section('content')
@include('reports._print-header', ['reportTitle' => 'Completed Diet Plans Report'])
...
@include('reports._summary-cards', ['cards' => [
    ['label' => 'Completed Plans', 'value' => $summary['completed_plans'], 'icon' => 'bi-check-circle', 'color' => 'success'],
    ['label' => 'Total Plans',     'value' => $summary['total_plans'],     'icon' => 'bi-journal-medical', 'color' => 'primary'],
]])
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
        <h6 class="fw-bold mb-0"><i class="bi bi-check-circle me-2"></i>Completed Nutrition Plans</h6>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light"><tr><th class="ps-3">Plan #</th><th>Patient</th><th>Diet Type</th><th>Dietitian</th><th>Completed Date</th></tr></thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted small">{{ $r->updated_at?->format('M d, Y') }}</td>
                    </tr>
                    @empty
                    <tr><td colspan="5" class="text-center py-4 text-muted"><i class="bi bi-inbox me-2"></i>No completed diet plans found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
