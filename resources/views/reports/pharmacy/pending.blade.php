@extends('layouts.app')
@section('title', 'Pending Prescriptions Report')
@section('page-title', 'Pending Prescriptions Report')
@section('content')
@include('reports._print-header', ['reportTitle' => 'Pending Prescriptions Report'])
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
        <h6 class="fw-bold mb-0"><i class="bi bi-hourglass-split me-2"></i>Pending Prescriptions</h6>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light"><tr><th class="ps-3">Rx #</th><th>Patient</th><th>Doctor</th><th>Items</th><th>Prescribed</th><th>Age</th></tr></thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted small">{{ $r->prescribed_at?->format('M d, Y') }}</td>
                        <td class="small">{{ $r->prescribed_at ? $r->prescribed_at->diffForHumans(null, true) : '—' }}</td>
                    </tr>
                    @empty
                    <tr><td colspan="6" class="text-center py-4 text-muted"><i class="bi bi-inbox me-2"></i>No pending prescriptions found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
