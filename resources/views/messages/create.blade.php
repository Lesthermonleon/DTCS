...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="mb-1 fw-bold text-body">
            <i class="bi bi-pencil-square text-success me-2"></i>New Staff Message
        </h4>
        <p class="text-body-secondary small mb-0">Compose a direct message to a HIMS staff member</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-body-tertiary border-bottom py-3">
                <h6 class="card-title fw-bold text-body mb-0">Compose Direct Message</h6>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('messages.store') }}" method="POST" id="composeMessageForm">
                    ...
                    {{-- Recipient Selection --}}
                    <div class="mb-4">
                        <label for="recipient_id" class="form-label fw-semibold text-body small">
                        ...
                        @enderror
                        <small class="text-body-secondary d-block mt-1">Select an active staff member or clinician from the list.</small>
                    </div>

                    {{-- Message Textarea --}}
                    <div class="mb-4">
                        <label for="message" class="form-label fw-semibold text-body small">
