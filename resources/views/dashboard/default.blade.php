...
<div class="card">
    <div class="card-body text-center py-5">
        ...
        <h5 style="font-family:var(--font-display);font-weight:600;color:var(--text);margin-bottom:.5rem;">
            Welcome, {{ auth()->user()->name }}
        </h5>
        <p style="color:var(--text-soft);font-size:.88rem;max-width:320px;margin:0 auto 1.5rem;">
            You are logged in to the DITC Hospital Management System.
